...
**중요: OCR 특성 고려**
- OCR로 인한 일반적인 오류(예: '따리서'→'따라서', '겅우'→'경우', '학생돌'→'학생들')는 지적하되 과도하게 감점하지 마세요
- 명백한 맞춤법 오류나 문법 오류만 지적하세요
- 문장 구조, 논리적 연결성, 표현의 적절성에 중점을 두세요
- 최대 3-4개의 개선 사항만 선택하여 제시하세요 (가장 중요한 것들만)

**분석 기준:**
1. 기존 보완점(weaknesses)과 개선 방안(improvements)을 참고하여 관련 문장 찾기
2. 맞춤법/띄어쓰기 오류 (OCR 오류 고려하여 융통성 있게)
...
중요: 반드시 3-4개 이하의 개선 사항만 선택하여 가장 중요한 것들만 제시하세요.
...
- reason은 왜 이렇게 수정해야 하는지 간단히 설명하세요
- 문제가 없는 문장은 포함하지 마세요
- 최대 3-4개의 가장 중요한 개선 사항만 선택하세요`
